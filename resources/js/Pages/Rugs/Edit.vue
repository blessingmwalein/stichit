                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-4">
                                    <div class="border border-3 p-4 rounded">
                                        ...
                                        <div v-for="(sizeId, index) in form.sizes" :key="index" class="mb-3">
...
export default {
    props: {
        ...
        rug: Object, // Rug data for editing
    },
    components: {
        BreadCrumb,
        MainLayout,
    ...
    data() {
        return {
            form: useForm({
                id: this.rug.data.id || '',
                name: this.rug.data.name || '',
                type: this.rug.data.type || '',
                approx_production_cost: this.rug.data.approx_production_cost || '',
                approx_cost: this.rug.data.approx_cost || '',
                sizes: this.rug.data.sizes.map(size => size.size_id), // Map to only size_id
            }),
            breadcrumbLinks: [
    ...
    methods: {
        ...
        submit() {
            this.form.post(route('rugs.update', this.form.id), {
                onFinish: () => {
                    // this.form.reset();
                },
            });
