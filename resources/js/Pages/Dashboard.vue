                        ...
                        <div class="card-body">
                            <div class="d-flex align-items-center">
                                <div>
                                    ...
                                    <p class="mb-0 font-13 text-white"><i class="bx bxs-up-arrow align-middle"></i>1.6K
                                        from last week</p>
                                </div>
                                <div class="widgets-icons bg-light-transparent text-white ms-auto"><i
                    ...
                    <div class="card radius-10 w-100">
                        ...
                        <div class="product-list p-3 mb-3">
                            ...
                            <div class="d-flex flex-column gap-3">
                                <div
                                    class="d-flex align-items-center justify-content-between gap-3 p-2 border radius-10">
                                    <div class="">
                    ...
                    <div class="card radius-10 w-100 overflow-hidden">
                        ...
                        <div class="card-body">
                            <div class="social-leads">
                                ...
                                <hr>
                                <div class="d-flex align-items-center gap-3">
                                    <div class="widgets-icons-small text-white bg-light"><i class='bx bxl-google'></i>
                                    </div>
                                    <div class="flex-grow-1">
                                ...
                                <hr>
                                <div class="d-flex align-items-center gap-3">
                                    <div class="widgets-icons-small text-white bg-light"><i class='bx bxl-twitter'></i>
                                    </div>
                                    <div class="flex-grow-1">
                                ...
                                <hr>
                                <div class="d-flex align-items-center gap-3">
                                    <div class="widgets-icons-small text-white bg-light"><i class='bx bxl-linkedin'></i>
                                    </div>
                                    <div class="flex-grow-1">
                                ...
                                <hr>
                                <div class="d-flex align-items-center gap-3">
                                    <div class="widgets-icons-small text-white bg-light"><i class='bx bxl-dribbble'></i>
                                    </div>
                                    <div class="flex-grow-1">
                                ...
                                <hr>
                                <div class="d-flex align-items-center gap-3">
                                    <div class="widgets-icons-small text-white bg-light"><i class='bx bxl-behance'></i>
                                    </div>
                                    <div class="flex-grow-1">
