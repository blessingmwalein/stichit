    ...
    <div class="wrapper">
        ...
        <div class="sidebar-wrapper" data-simplebar="true">
            <div class="sidebar-header bg-white">
                ...
                <div>
                    <h4 class="logo-text text-black">Stitchit</h4>
                </div>
                <div class="toggle-icon ms-auto text-black"><i class='bx bx-arrow-back'></i>
                </div>
            </div>
            <!--navigation-->
            <ul class="metismenu" id="menu">
                ...
                <li class="menu-label">Stitchit</li>
        ...
        <footer class="page-footer">
            <p class="mb-0">Copyright © {{ currentYear }}. All right reserved.</p>
        </footer>
    </div>
